...
Azure Synapse Analytics is an end-to-end analytics solution primarily used for data warehousing(It includes right from gathering data from different sources to building fact and dim tables).
